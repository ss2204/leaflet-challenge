...
d3.json(BaseURL, function (data) {
  ...
  function getColor(d) {
    switch (true) {
      case (d > 90) : return '#b31b1b'; 
      break; 
      case (d > 70 && d <= 90) : return '#ff8243'; 
      break;
      case (d > 50 && d <= 70) : return '#e25822'; 
      break; 
      case (d > 30 && d <= 50) : return '#f8de7e'; 
      break; 
      case (d > 10 && d <= 30) : return '#ccff00'; 
      break;  
      case (d > -10 && d <= 10) : return '#00ff00'; 
      break; 
      default: return '#087830';  
    }
  }
